...
export default function AboutPageClient() {
  ...
  const coreValues = [
    {
      icon: '🌾',
      title: 'Quality Agriculture',
      description: 'Providing premium cassava flour and nutritious porridge made from the finest locally sourced ingredients.',
    },
    {
      icon: '🐔',
      title: 'Healthy Livestock',
      description: 'Raising and supplying healthy chickens, quails, rabbits, and ducks with proper care and nutrition.',
    },
    {
      icon: '🤝',
      title: 'Customer Trust',
      description: 'Building lasting relationships through transparency, quality products, and exceptional service.',
    },
    {
      icon: '🌱',
      title: 'Sustainability',
      description: 'Supporting local farmers and promoting sustainable agricultural practices for future generations.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              Our dedicated team of agricultural experts and livestock specialists are committed to bringing you the finest cassava products and healthy livestock. United by our passion for quality agriculture and customer satisfaction, we work tirelessly to ensure every product meets our high standards.
            </p>
          </div>
          {teamLoading ? (
